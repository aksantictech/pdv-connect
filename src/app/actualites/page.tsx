...
const featuredPost = posts.find((post) => post.is_featured) ?? posts[0] ?? null;

const otherPosts = featuredPost
? posts.filter((post) => post.id !== featuredPost.id)
: [];

return ( <main className="min-h-screen bg-[#f7faff]"> <section className="bg-gradient-to-br from-[#061d45] via-[#0a3d82] to-[#1680c4] px-5 py-20 text-white lg:px-8"> <div className="mx-auto max-w-7xl"> <p className="text-sm font-black uppercase tracking-[0.18em] text-cyan-200">
CEF Parole de Vie </p>
