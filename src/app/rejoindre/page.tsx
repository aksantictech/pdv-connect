...
export default function RejoindrePage() {
  ...
  useEffect(() => {
    async function loadOptions() {
      ...
      const [assembliesResult, departmentsResult] = await Promise.all([
        supabase
          .from("assemblies")
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <section className="border-b border-blue-100 bg-gradient-to-br from-[#082553] via-[#0a3d82] to-[#1680c4] px-5 py-14 text-white lg:px-8">
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-[1fr_0.9fr] lg:items-end">
            <div>
              ...
              <h1 className="mt-6 text-4xl font-black leading-tight sm:text-5xl">
                Bienvenue à CEF
                <span className="block text-cyan-200">Parole de Vie.</span>
              </h1>

              <p className="mt-5 max-w-2xl text-base leading-8 text-blue-100">
                Complétez ce formulaire afin que notre équipe puisse vous
                accueillir, vous accompagner et vous aider à trouver votre
            ...
            <div className="rounded-3xl border border-white/20 bg-white/10 p-6 backdrop-blur">
              <div className="flex gap-3">
                <HeartHandshake className="shrink-0 text-cyan-200" size={27} />
                <div>
                  <p className="font-extrabold">Un accueil personnalisé</p>
                  <p className="mt-1 text-sm leading-6 text-blue-100">
                    Votre inscription sera reçue par l’équipe d’intégration de
                    votre assemblée.
                  </p>
                </div>
              </div>
          ...
          {loadingOptions ? (
            ...
            <>
              <div className="mb-9 flex items-start gap-4 border-b border-slate-100 pb-7">
                ...
                <div>
                  <h2 className="text-2xl font-black text-[#092e63]">
                    Vos informations
                  </h2>
              ...
              <label className="mt-7 flex cursor-pointer items-start gap-3 rounded-2xl border border-slate-200 p-5">
                ...
                <span className="text-sm leading-6 text-slate-600">
                  ...
                  uniquement pour mon accueil, mon suivi pastoral et mon
              ...
              <div className="mt-8 flex flex-col justify-between gap-4 border-t border-slate-100 pt-7 sm:flex-row sm:items-center">
                <div className="flex items-center gap-2 text-xs leading-5 text-slate-500">
                  ...
                  Vos informations sont protégées et accessibles uniquement aux
